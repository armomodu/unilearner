 ...
 */
export function sanitizeGenerationData(generation: any): {
  id?: string;
  status: string;
  currentStep?: string;
 ...
 */
export function hasPerformanceMetrics(generation: any): boolean {
  return generation && (
 ...
 */
export function getGenerationStatusDisplay(generation: any): {
  status: string;
  isComplete: boolean;
  hasError: boolean;
  progress: number;
